...
api_router.include_router(
    reflections_router, prefix="/api/reflections", tags=["reflections"]
)
api_router.include_router(
    report_write_router, prefix="/api/reflections", tags=["reports"]
)
api_router.include_router(
    report_read_router, prefix="/api/reflections", tags=["reports"]
)
